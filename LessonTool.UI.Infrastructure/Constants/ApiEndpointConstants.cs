namespace LessonTool.UI.Infrastructure.Constants;

public static class ApiEndpointConstants
{
    public const string CommonApiClientName = "Common";
    public const string AuthenticationApiClientName = "Authentication";
